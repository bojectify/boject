...
```typescript
import { retry, createRetry, withRetry, TimeoutError } from '@boject/async';
...
Attempting to import from `@boject/colors` or `@boject/strings` will result in a linting error due to module boundary constraints.
