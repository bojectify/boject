...
```typescript
import { capitalize, slugify } from '@boject/strings';
...
Attempting to import from `@boject/colors` or `@boject/async` will result in a linting error due to module boundary constraints.
